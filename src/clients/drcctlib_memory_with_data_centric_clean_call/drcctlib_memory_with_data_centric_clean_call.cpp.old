...
#define DRCCTLIB_EXIT_PROCESS(_FORMAT, _ARGS...)                                           \
    DRCCTLIB_CLIENT_EXIT_PROCESS_TEMPLATE("memory_with_data_centric_clean_call", _FORMAT, \
                                          ##_ARGS)
...
ClientExit(void)
{
    ...
    if (!drmgr_unregister_thread_init_event(ClientThreadStart) ||
        ...
        DRCCTLIB_PRINTF("ERROR: drcctlib_memory_with_data_centric_clean_call failed to "
...
{
    dr_set_client_name("DynamoRIO Client 'drcctlib_memory_with_data_centric_clean_call'",
                       "http://dynamorio.org/issues");
    ClientInit(argc, argv);

    if (!drmgr_init()) {
        DRCCTLIB_EXIT_PROCESS("ERROR: drcctlib_memory_with_data_centric_clean_call "
